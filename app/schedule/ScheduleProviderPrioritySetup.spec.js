...
import type {MessageProviderName} from "./ScheduleProviderPrioritySetup";
...
describe('ScheduleProviderPrioritySetup', () => {
    const calendars : {[url : string] : {url: string, name: string, messageProvider : MessageProviderName}} = {
        "calendar-1-1": {url: "calendar-1-1", name: "calendar-1-1", messageProvider: 'Entur'},
        "calendar-1-2": {url: "calendar-1-2", name: "calendar-1-2", messageProvider: 'Entur'},
        "calendar-1-3": {url: "calendar-1-3", name: "calendar-1-3", messageProvider: 'Entur'},
        "calendar-2-1": {url: "calendar-2-1", name: "calendar-2-1", messageProvider: 'Entur'},
        "calendar-2-2": {url: "calendar-2-2", name: "calendar-2-2", messageProvider: 'Entur'},
        "calendar-3-1": {url: "calendar-3-2", name: "calendar-3-2", messageProvider: 'Entur'},
    };
    it('should create a list of prioritized calendars for each column', function () {
        ...
        const prioritizedLists : Array<Array<{url: string, name : string, messageProvider : MessageProviderName}>> = setup.getPrioritizedLists();
