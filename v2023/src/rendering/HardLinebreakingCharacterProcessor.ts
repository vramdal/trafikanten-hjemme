const {LinebreakAnnotation} = require("./LinebreakAnnotation");
...
class HardLinebreakingCharacterProcessor implements CharacterProcessor {
    ...
    characterMap : Array<{chIdx: number, str?: string} | undefined>;
...
export default HardLinebreakingCharacterProcessor;
