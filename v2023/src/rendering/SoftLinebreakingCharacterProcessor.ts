import LinebreakAnnotation from "./LinebreakAnnotation";
...
class SoftLinebreakingCharacterProcessor implements CharacterProcessor {
    ...
    softLinebreakUnderCreation: {chStart : number, chEnd: number, xStart: number} | undefined;
...
export default SoftLinebreakingCharacterProcessor;
